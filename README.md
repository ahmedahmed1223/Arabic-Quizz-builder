...
- 📱 [`releases/quiz-platform-v14.2-android.apk`](releases/quiz-platform-v14.2-android.apk) (7.3 ميجابايت)
...
| المعلومة | القيمة |
|----------|--------|
| **اسم الحزمة** | `com.ahmedahmed1223.arabicquizzbuilder` |
| **اسم التطبيق** | المسابقات |
| **حجم APK** | 7.3 ميجابايت |
| **minSdkVersion** | 23 (Android 6.0+) |
| **targetSdkVersion** | 35 (Android 15) |
| **اللغة** | العربية (RTL) + الإنجليزية |
| **العمل أوفلاين** | ✅ نعم (بعد التحميل الأول) |
