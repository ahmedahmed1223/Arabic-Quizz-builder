...
└── src/
    ...
    │   └── loading-v14.css             # [V16 محدّث] شاشة التحميل العصرية
    │
    ...
    │   ├── 00-icon-library.js          # [V16 محدّث] مكتبة أيقونات SVG (159 أيقونة)
    ...
    │   ├── 11-builtin-library.js       # [V16 محدّث] مكتبة الأسئلة المدمجة (منفصلة) — 20 قسماً، 318 سؤالاً
...
- [Lucide](https://lucide.dev/) — مصدر الإلهام لمكتبة الأيقونات V16
...
| **أيقونات SVG مضمّنة (V16)** | **159** |
| **أقسام المكتبة المدمجة (V16)** | **75** |
| **أسئلة المكتبة المدمجة (V16)** | **3468** |
| **أقسام المكتبة الخارجية** | **75** |
| **أسئلة المكتبة الخارجية** | **3468** |
| حجم ناتج البناء | ~4.5 ميجابايت (ملف واحد) |
| اللغات المدعومة | 4 (عربي، إنجليزي، فرنسي، أوردي) |
| السمات | 19 جاهزة + مخصص + كشف تلقائي |
| أنواع الأسئلة | 10 |
| أنماط العرض | 5 |
